...
public class PrimitiveGenerator {
  ...
  public CharSequence compileEffectFull() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private final static Scanner scanner = new Scanner(System.in);");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public static IO<String> getLineStdIn() {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return () -> scanner.next();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public static IO<Integer> getIntStdIn() {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return () -> scanner.nextInt();");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
