...
@after {
	...
	(
		...
		{
			$current = $this_EffectFullFunctionValue_11.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EffectFullProdValue_13.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EffectFullSumValue_14.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EffectFullValueRef_15.current;
			afterParserOrEnumRuleCall();
		}
	)
;
