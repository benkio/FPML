...
public class EffectFullDataTypeImpl extends EffectFullTypeImpl implements EffectFullDataType
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == EffectFullExpression.class)
    {
      ...
      {
        case FPMLPackage.EFFECT_FULL_DATA_TYPE__INNER_VALUE: return FPMLPackage.EFFECT_FULL_EXPRESSION__INNER_VALUE;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == EffectFullExpression.class)
    {
      ...
      {
        case FPMLPackage.EFFECT_FULL_EXPRESSION__INNER_VALUE: return FPMLPackage.EFFECT_FULL_DATA_TYPE__INNER_VALUE;
        default: return -1;
      }
    }
