...
public class EffectFullFunctionTypeImpl extends EffectFullTypeImpl implements EffectFullFunctionType
{
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == EffectFullAdtValue.class)
    {
      switch (derivedFeatureID)
      {
        case FPMLPackage.EFFECT_FULL_FUNCTION_TYPE__INNER_VALUE: return FPMLPackage.EFFECT_FULL_ADT_VALUE__INNER_VALUE;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    ...
    if (baseClass == EffectFullAdtValue.class)
    {
      switch (baseFeatureID)
      {
        case FPMLPackage.EFFECT_FULL_ADT_VALUE__INNER_VALUE: return FPMLPackage.EFFECT_FULL_FUNCTION_TYPE__INNER_VALUE;
        default: return -1;
      }
    }
