		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPureExpressionAndPureFunctionReferenceAccess().getAlternatives(), "rule__PureExpressionAndPureFunctionReference__Alternatives");
					put(grammarAccess.getPureSumValueAccess().getAlternatives(), "rule__PureSumValue__Alternatives");
					put(grammarAccess.getEffectFullExpressionAndEffectFullFunctionReferenceAccess().getAlternatives(), "rule__EffectFullExpressionAndEffectFullFunctionReference__Alternatives");
					...
					put(grammarAccess.getPureIfBodyAccess().getAlternatives(), "rule__PureIfBody__Alternatives");
					...
					put(grammarAccess.getEffectFullIfBodyAccess().getAlternatives(), "rule__EffectFullIfBody__Alternatives");
					...
					put(grammarAccess.getLeftAlgebraicAccess().getGroup(), "rule__LeftAlgebraic__Group__0");
					put(grammarAccess.getRightAlgebraicAccess().getGroup(), "rule__RightAlgebraic__Group__0");
					...
					put(grammarAccess.getLogicNotAccess().getGroup(), "rule__LogicNot__Group__0");
					put(grammarAccess.getExtractPureAccess().getGroup(), "rule__ExtractPure__Group__0");
					put(grammarAccess.getIsLeftPureAccess().getGroup(), "rule__IsLeftPure__Group__0");
					put(grammarAccess.getIsRightPureAccess().getGroup(), "rule__IsRightPure__Group__0");
					put(grammarAccess.getPureIfAccess().getGroup(), "rule__PureIf__Group__0");
					put(grammarAccess.getPureEitherIfAccess().getGroup(), "rule__PureEitherIf__Group__0");
					put(grammarAccess.getPureReturnAccess().getGroup(), "rule__PureReturn__Group__0");
					put(grammarAccess.getPrintAccess().getGroup(), "rule__Print__Group__0");
					put(grammarAccess.getLeftAlgebraicIOAccess().getGroup(), "rule__LeftAlgebraicIO__Group__0");
					put(grammarAccess.getRightAlgebraicIOAccess().getGroup(), "rule__RightAlgebraicIO__Group__0");
					put(grammarAccess.getRandomAccess().getGroup(), "rule__Random__Group__0");
					put(grammarAccess.getEffectFullReturnAccess().getGroup(), "rule__EffectFullReturn__Group__0");
					...
					put(grammarAccess.getIsLeftEffectFullAccess().getGroup(), "rule__IsLeftEffectFull__Group__0");
					...
					put(grammarAccess.getPureExpressionAndPureFunctionReferenceAccess().getProdAdtElementExpressionAssignment_0(), "rule__PureExpressionAndPureFunctionReference__ProdAdtElementExpressionAssignment_0");
					put(grammarAccess.getPureExpressionAndPureFunctionReferenceAccess().getProdAdtElementFunctionAssignment_1(), "rule__PureExpressionAndPureFunctionReference__ProdAdtElementFunctionAssignment_1");
					...
					put(grammarAccess.getEffectFullExpressionAndEffectFullFunctionReferenceAccess().getProdAdtElementExpressionAssignment_0(), "rule__EffectFullExpressionAndEffectFullFunctionReference__ProdAdtElementExpressionAssignment_0");
					put(grammarAccess.getEffectFullExpressionAndEffectFullFunctionReferenceAccess().getProdAdtElementFunctionAssignment_1(), "rule__EffectFullExpressionAndEffectFullFunctionReference__ProdAdtElementFunctionAssignment_1");
					...
					put(grammarAccess.getLeftAlgebraicAccess().getTypeAssignment_2(), "rule__LeftAlgebraic__TypeAssignment_2");
					put(grammarAccess.getRightAlgebraicAccess().getTypeAssignment_2(), "rule__RightAlgebraic__TypeAssignment_2");
					...
					put(grammarAccess.getIsLeftPureAccess().getTypeAssignment_2(), "rule__IsLeftPure__TypeAssignment_2");
					put(grammarAccess.getIsRightPureAccess().getTypeAssignment_2(), "rule__IsRightPure__TypeAssignment_2");
					put(grammarAccess.getPureIfAccess().getThenAssignment_4(), "rule__PureIf__ThenAssignment_4");
					put(grammarAccess.getPureIfAccess().getElseAssignment_8(), "rule__PureIf__ElseAssignment_8");
					put(grammarAccess.getPureIfBodyAccess().getFunctionReferenceAssignment_0(), "rule__PureIfBody__FunctionReferenceAssignment_0");
					put(grammarAccess.getPureIfBodyAccess().getFunctionExpressionAssignment_1(), "rule__PureIfBody__FunctionExpressionAssignment_1");
					put(grammarAccess.getPureEitherIfAccess().getThenAssignment_4(), "rule__PureEitherIf__ThenAssignment_4");
					put(grammarAccess.getPureEitherIfAccess().getElseAssignment_8(), "rule__PureEitherIf__ElseAssignment_8");
					put(grammarAccess.getPureReturnAccess().getTypeAssignment_2(), "rule__PureReturn__TypeAssignment_2");
					put(grammarAccess.getLeftAlgebraicIOAccess().getTypeAssignment_2(), "rule__LeftAlgebraicIO__TypeAssignment_2");
					put(grammarAccess.getRightAlgebraicIOAccess().getTypeAssignment_2(), "rule__RightAlgebraicIO__TypeAssignment_2");
					put(grammarAccess.getEffectFullReturnAccess().getTypeAssignment_2(), "rule__EffectFullReturn__TypeAssignment_2");
					...
					put(grammarAccess.getIsLeftEffectFullAccess().getTypeAssignment_2(), "rule__IsLeftEffectFull__TypeAssignment_2");
					put(grammarAccess.getIsRightEffectFullAccess().getTypeAssignment_2(), "rule__IsRightEffectFull__TypeAssignment_2");
					put(grammarAccess.getEffectFullIfAccess().getThenAssignment_4(), "rule__EffectFullIf__ThenAssignment_4");
					put(grammarAccess.getEffectFullIfAccess().getElseAssignment_8(), "rule__EffectFullIf__ElseAssignment_8");
					put(grammarAccess.getEffectFullEitherIfAccess().getThenAssignment_4(), "rule__EffectFullEitherIf__ThenAssignment_4");
					put(grammarAccess.getEffectFullEitherIfAccess().getElseAssignment_8(), "rule__EffectFullEitherIf__ElseAssignment_8");
					put(grammarAccess.getEffectFullIfBodyAccess().getFunctionReferenceAssignment_0(), "rule__EffectFullIfBody__FunctionReferenceAssignment_0");
					put(grammarAccess.getEffectFullIfBodyAccess().getFunctionExpressionAssignment_1(), "rule__EffectFullIfBody__FunctionExpressionAssignment_1");
				}
			};
		}
